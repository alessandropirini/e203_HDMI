...
module e203_subsys_perips(
  ...
  .O14_BASE_REGION_LSB (12),
      ...
      // * Here is an I2C WishBone Peripheral Here we put our MODULE HDMI 
...
// my peripheral example HDMI
icb_bus_HDMI u_HDMI_top(
    .clk            (clk),
    .rst_n          (rst_n),
    .HDMI_icb_cmd_valid (my_periph_icb_cmd_valid),
    .HDMI_icb_cmd_ready (my_periph_icb_cmd_ready),
    .HDMI_icb_cmd_addr  (my_periph_icb_cmd_addr ),
    .HDMI_icb_cmd_read  (my_periph_icb_cmd_read ),
    .HDMI_icb_cmd_wdata (my_periph_icb_cmd_wdata),

    .HDMI_icb_rsp_valid (my_periph_icb_rsp_valid),
    .HDMI_icb_rsp_ready (my_periph_icb_rsp_ready),
    .HDMI_icb_rsp_rdata (my_periph_icb_rsp_rdata), 

    .HDMI_io_interrupts_0_0 (my_irq),                
    .HDMI_io_pad_out       (my_io_pad_out)
);
...
main final_top(
    .clk            (FPGA_clk), 
    .rst_n          (rst_n), 
    .pad_out        (my_io_pad_out),
    .O_tmds_clk_p_o(O_tmds_clk_p_o), 
	  .O_tmds_clk_n_o(O_tmds_clk_n_o), 
	  .O_tmds_data_p_o(O_tmds_data_p_o),
	  .O_tmds_data_n_o(O_tmds_data_n_o) 
);
