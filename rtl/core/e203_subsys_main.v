...
module e203_subsys_main(
  ...
  input  hfextclk,// The original clock from crystal 16Mhz
...
`endif//}
    ...
    .gpio_irq_30            (gpio_irq_30),
    .gpio_irq_31            (gpio_irq_31),
    .O_tmds_clk_p_o(O_tmds_clk_p_o), //output O_tmds_clk_p
	 .O_tmds_clk_n_o(O_tmds_clk_n_o), //output O_tmds_clk_n
	 .O_tmds_data_p_o(O_tmds_data_p_o), //output [2:0] O_tmds_data_p
